...
public class DBSpringBoot implements CommandLineRunner {
    ...
    private void update() {
        String updateSQL = "UPDATE test_table SET testdesc = 'some test in java spring boot' WHERE testId = 4;";
    ...
    private void insert() {
        String insertSQL = "INSERT INTO test_table (testdesc) VALUES ('Test in Java Spring Boot');";
